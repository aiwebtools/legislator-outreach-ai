...
const Footer = () => {
  const footerLinks = [
    ...
    { name: 'More AI Tools', href: AIWEBTOOLS_URL },
  ];
  
  const legalLinks = [
    { name: 'Privacy Policy', href: 'https://openai.com/policies/privacy-policy/' },
    { name: 'Terms of Service', href: `${AIWEBTOOLS_URL}` },
  ];
      ...
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Target className="w-8 h-8 text-cyber-blue shrink-0" />
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-400">
                  Free AI Tool by <a href={AIWEBTOOLS_URL} className="text-cyber-pink hover:text-cyber-purple transition-colors" title="AIWEBTOOLS.AI - Free AI Tools">AIWEBTOOLS.AI</a>
                </p>
              </div>
            </div>
        ...
        <div className="mt-12 pt-4 border-t border-cyber-blue/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-500">
            © 2025 <a href={AIWEBTOOLS_URL} className="cyber-link" title="AI WEB TOOLS LLC - Free AI Tools Provider">AI WEB TOOLS LLC</a> All rights reserved. 
            Leading provider of free AI tools and AI web tools.
          </p>
          <div className="flex gap-4 mt-4 md:mt-0">
            <a href={AIWEBTOOLS_URL} className="text-cyber-blue hover:text-cyber-purple transition-colors" title="AIWEBTOOLS.AI on Facebook">
            ...
            <a href={AIWEBTOOLS_URL} className="text-cyber-blue hover:text-cyber-purple transition-colors" title="AIWEBTOOLS.AI on Twitter">
            ...
            <a href={AIWEBTOOLS_URL} className="text-cyber-blue hover:text-cyber-purple transition-colors" title="AIWEBTOOLS.AI on LinkedIn">
